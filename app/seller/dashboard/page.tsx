...
export default async function SellerDashboard() {
    ...
    const pendingOrders = recentOrders.filter((o: any) => o.deliveryStatus === 'PENDING' || o.deliveryStatus === 'SHIPPED').length;
                    ...
                    <div className="bg-gradient-to-r from-blue-900 to-indigo-800 rounded-2xl p-6 text-white shadow-lg lg:col-span-2 relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-blue-100 mb-6 max-w-lg">
                                You have <strong className="text-white">{pendingOrders} pending orders</strong> and <strong className="text-white">{displayLeads.length} new leads</strong> matching your profile today.
                            </p>
                                            ...
                                            {recentOrders.map((order: any) => (
                                                <tr key={order._id.toString()} className="hover:bg-gray-50 group transition-colors">
                                                    ...
                                                    <td className="p-4 pr-6 text-right">
                                                        <Link href={`/seller/orders?id=${order.orderId}`} className="text-gray-400 hover:text-blue-600 font-bold text-xs flex items-center justify-end gap-1 group-hover:translate-x-1 transition-transform">
