                            ...
                            {loadingConversations ? (
                                ...
                                conversations.map((conv) => (
                                    <div
                                        ...
                                        className={`flex items-center p-4 cursor-pointer border-b border-gray-100 transition-colors ${conv.partnerId === selectedSellerId ? 'bg-indigo-50 border-l-4 border-l-indigo-600' : 'hover:bg-gray-50'
                                            }`}
                                    >
                                        ...
                                        messages.map((msg) => (
                                            <div key={msg._id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                                {msg.type === 'OFFER' || msg.type === 'PAYMENT_LINK' ? (
                                                    <div className={`max-w-[85%] border rounded-xl p-4 shadow-sm ${msg.sender === 'seller' ? 'bg-green-50 border-green-200' : 'bg-blue-50 border-blue-200'}`}>
