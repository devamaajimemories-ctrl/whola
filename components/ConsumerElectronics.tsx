                    ...
                    <div className="w-full lg:w-1/4 relative rounded-2xl overflow-hidden shadow-lg group min-h-[400px]">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-6">
                            <div className="space-y-2 mb-6">
                                <Link href="#" className="block text-white/90 hover:text-white hover:translate-x-1 transition-transform">Adaptors, Plugs and Sockets</Link>
                                <Link href="#" className="block text-white/90 hover:text-white hover:translate-x-1 transition-transform">Indoor Lights & Fittings</Link>
                                <Link href="#" className="block text-white/90 hover:text-white hover:translate-x-1 transition-transform">Freezers, Refrigerators</Link>
                                <Link href="#" className="block text-white/90 hover:text-white hover:translate-x-1 transition-transform">Audio Video System</Link>
                            </div>
